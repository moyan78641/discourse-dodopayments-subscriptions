          ...
          {{#each @controller.model as |subscription|}}
            <article class="dodo-user-subscription">
              <div class="dodo-user-subscription__top">
                <div>
                  <span class="dodo-user-subscription__label">
                    {{i18n "discourse_dodo_subscriptions.user.subscriptions.plan"}}
                  </span>
              ...
              <dl class="dodo-user-subscription__details">
                <div>
                  <dt>{{i18n "discourse_dodo_subscriptions.user.subscriptions.price"}}</dt>
                ...
                <div>
                  <dt>{{i18n "discourse_dodo_subscriptions.user.subscriptions.started_at"}}</dt>
                  <dd>{{subscription.createdAtLabel}}</dd>
                </div>
                <div>
                  <dt>{{i18n "discourse_dodo_subscriptions.user.subscriptions.renewal"}}</dt>
